...
На GPU: matmul (Q8_0 и FP32), FFN residency, attn+FFN residual (WO+RMSNorm+FFN, parallel RMSNorm apply), attention (+ softmax), KV-cache. Отключить residual: `GGUF_ATTN_FFN_RESIDENCY=0`. RoPE на CPU.
